package ficheros_Aleatorio;

import java.io.*;

public class EscribirFichAleatorio {
    public static void main(String[] args) throws IOException {
        String ruta="C:\\Users\\Isabel\\eclipse-workspace\\adt_t1\\src\\FicherosPruebas\\FichBinarioAleatorio\\";
        File fic = new File(ruta + "AleatorioEmple.dat");
